...
class TestCard(unittest.TestCase):
    ...
    def test_q1(self):
        ...
        #c4 = hw5_cards.Card(3, 12)
        self.assertEqual(c1.rank_name, "Queen")
        #self.assertEqual(c2.rank_name, "Queen")
        #self.assertEqual(c3.rank_name, "Queen")
        #self.assertEqual(c4.rank_name, "Queen")
    ...
    def test_q3(self):
        ...
        self.assertTrue(str(c1), "King of Spades")
    ...
    def test_q5(self):
        ...
        c1 = hw5_cards.Card()
        d1 = hw5_cards.Deck()
        self.assertIsInstance(d1.deal_card(), type(c1))
        return d1.deal_card(), type(c1)
    ...
    def test_q6(self):
        ...
        d2 = d1
        self.assertEqual(len(d1.cards), (len(d_original.cards)-1))
        return len(d1.cards), (len(d_original.cards)-1)
